...
CREATE TABLE `pacientes` (
	`pct_pront` int NOT NULL AUTO_INCREMENT UNIQUE,
...
CREATE TABLE `endereco` (
	`enderec_id` int NOT NULL AUTO_INCREMENT,
	`enderec_rua` varchar (50) NOT NULL,
	`enderec_num` int NOT NULL,
	...
	`pct_pront_enderec` int NOT NULL,
...
CREATE TABLE `cid` (
	`cid_id` int NOT NULL AUTO_INCREMENT UNIQUE,
	`cid_cid` varchar (5) NOT NULL UNIQUE,
	`cid_descri` varchar (30) NOT NULL,
	PRIMARY KEY (`cid_id`)
);
...
CREATE TABLE `usuario` (
	...
	`insti_id_user` int NOT NULL,
	PRIMARY KEY (`user_id`)
);

CREATE TABLE `casa_crianca` (
	`insti_id` int NOT NULL AUTO_INCREMENT UNIQUE,
